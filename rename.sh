...
sed -i "" "s/BackEndApiTemplate_test/$1Test/" backendapitemplatetest/backendapitemplatetest.csproj
sed -i "" "s/BackEndApiTemplate/$1/" backendapitemplate/backendapitemplate.csproj
sed -i "" "s/BackEndApiTemplate_test/$1Test/" backendapitemplatetest/UnitTest1.cs
